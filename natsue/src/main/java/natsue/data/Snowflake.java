 ...
 * Not 100% accurate because it doesn't do the machine ID thing.
 * Instead the machine ID is used for upper timestamp bits but can also be used for extra sequence numbers in a pickle.
 */
