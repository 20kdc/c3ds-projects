...
creature-monitor/creature-monitor: creature-monitor/main.cpp creature-monitor/page-elf64.o
	$(CC) -fno-rtti -fno-exceptions creature-monitor/main.cpp creature-monitor/page-elf64.o -lSDL2 -lSDL2_net -o $@
...
creature-monitor/creature-monitor.exe: creature-monitor/main.cpp creature-monitor/page-coff.o
	$(W32_CC) -fno-rtti -fno-exceptions $(W32_CFLAGS_SDL) creature-monitor/main.cpp creature-monitor/page-coff.o -o $@ -lSDL2 -lSDL2_net
