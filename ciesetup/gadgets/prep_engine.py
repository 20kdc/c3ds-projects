...
launcher_file.write("export LD_LIBRARY_PATH=\"$SCRIPT_DIR\"\n")
launcher_file.write("export LD_PRELOAD=\"$SCRIPT_DIR/runtime.so\"\n")
...
launcher_file.write("\tcp \"$SCRIPT_DIR/lc2e-netbabel.so\" lc2e-netbabel.so\n")
