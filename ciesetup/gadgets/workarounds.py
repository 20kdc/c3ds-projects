...
launcher_file.write("You would put Creatures 3's files in this directory - use 'make c3' in the ciesetup source directory if you need to convert from a Windows build.\n")
...
launcher_file.write("# and do some fancy initialization\n")
...
launcher_file.write("\tmkdir -p \"Creatures 3/Users\"\n")
launcher_file.write("\tcp \"Catalogue/vocab constructs.catalogue\" \"Creatures 3/Catalogue/vocab constructs.catalogue\"\n")
launcher_file.write("\tcp \"ciesetup/c3-machine.cfg\" \"Creatures 3/machine.cfg\"\n")
launcher_file.write("\tcp \"ciesetup/c3-inituser.cfg\" \"Creatures 3/user.cfg\"\n")
...
os.system("cp " + gadgets_base + "c3-machine.cfg ./ciesetup/")
os.system("cp " + gadgets_base + "c3-inituser.cfg ./ciesetup/")
